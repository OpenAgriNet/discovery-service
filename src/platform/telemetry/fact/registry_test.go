...
//
// The line this draws is opentelemetry.md §Divergences from the spec: same
// value under two
...
// file. opentelemetry.md §Two fixtures, two jobs says so plainly and ranks the
// three mitigations;
...
//
// opentelemetry.md §Two fixtures, two jobs says "generated by go:generate".
// This is that, with the
