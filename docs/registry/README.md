...
## Everything else here is [`imported/`](imported/README.md)
...
what `discover` and `publish` mean. **It is binding on nothing here.** It covers eight
providers, eleven bindings and four call shapes; this page covers five, five and one.

Go there for the *why* behind something this page states:
[schema reasoning](imported/02-registry-schema.md) ·
[a full call with real payloads](imported/usecases/mausamgram.md) ·
[what the upstreams do today](imported/background/PROVIDERS.md) ·
[what they left unresolved](imported/reference/open-issues.md).

Where it and this page disagree, it is describing BV and this is describing us. Where
