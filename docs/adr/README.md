...
| [0011](0011-telemetry-opentelemetry.md) | OpenTelemetry for tracing (amended by A23 — no `otelhttp`, no in-process **network** metrics; and by A25, which narrows that to the network signal and reinstates the operator one) | D11, T2 |
